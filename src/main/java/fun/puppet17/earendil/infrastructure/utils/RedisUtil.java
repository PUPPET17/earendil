package fun.puppet17.earendil.infrastructure.utils;
...
public class RedisUtil {
    ...
    @Qualifier("redisTemplateP")
    private final RedisTemplate<String, Object> redisTemplate;
    
    public RedisUtil(@Qualifier("redisTemplateP")RedisTemplate<String, Object> redisTemplate) {
